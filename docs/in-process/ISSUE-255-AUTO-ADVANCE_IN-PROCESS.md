...
| Phase 2 – Feature 1 (`never_overdue_clear_at_approval_reset`)    | New overdue-lane option: never overdue presentation **plus** reset at the boundary  | 0%         | Presentation + scan-exclusion pair is the critical trap (`can_be_overdue`)    |
