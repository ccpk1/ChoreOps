"""Test helpers for ChoreOps integration tests.
...
- constants.py: All ChoreOps constants for test assertions
...
from tests.helpers.constants import (
    ...
    # Domain
    COORDINATOR,
    # Data keys - approver fields (shadow assignee support)
    ...
    DATA_ASSIGNEE_CHORE_DATA_LAST_MISSED,  # Phase 5
    DATA_ASSIGNEE_CHORE_DATA_PENDING_CLAIM_COUNT,
    DATA_ASSIGNEE_CHORE_DATA_PERIOD_APPROVED,  # v43+ approved count key
    DATA_ASSIGNEE_CHORE_DATA_PERIOD_MISSED,  # Phase 5
    DATA_ASSIGNEE_CHORE_DATA_PERIODS,  # Phase 5
    DATA_ASSIGNEE_CHORE_DATA_PERIODS_ALL_TIME,  # v43+ all_time bucket key
    DATA_ASSIGNEE_CHORE_DATA_PERIODS_DAILY,  # Phase 5
    DATA_ASSIGNEE_CHORE_DATA_PERIODS_MONTHLY,  # Phase 5
    DATA_ASSIGNEE_CHORE_DATA_PERIODS_WEEKLY,  # Phase 5
    DATA_ASSIGNEE_CHORE_DATA_PERIODS_YEARLY,  # Phase 5
...
from tests.helpers.validation import (
    ...
    count_entities_by_assignee,
    # Entity counting
    count_entities_by_platform,
    # Batch operations
    get_all_entity_states,
    get_assignee_entity_ids,
    # Entity verification
    verify_assignee_entities,
    verify_entity_state,
)
...
from tests.helpers.workflows import (
    ...
    get_assignee_points,
    get_chore_buttons,
    get_chore_states_all_assignees,
...
__all__ = [  # noqa: RUF022
    ...
    "CFOF_ASSIGNEES_INPUT_DASHBOARD_LANGUAGE",
    "CFOF_ASSIGNEES_INPUT_HA_USER",
    # Config/Options Flow Constants - Assignees
    "CFOF_ASSIGNEES_INPUT_ASSIGNEE_NAME",
    "CFOF_ASSIGNEES_INPUT_MOBILE_NOTIFY_SERVICE",
    "CFOF_APPROVERS_INPUT_ALLOW_CHORE_ASSIGNMENT",
    "CFOF_APPROVERS_INPUT_ASSOCIATED_ASSIGNEES",
    ...
    "CFOF_APPROVERS_INPUT_HA_USER",
    "CFOF_APPROVERS_INPUT_MOBILE_NOTIFY_SERVICE",
    # Config/Options Flow Constants - Approvers
    "CFOF_APPROVERS_INPUT_NAME",
    "CFOF_PENALTIES_INPUT_DESCRIPTION",
    "CFOF_PENALTIES_INPUT_ICON",
    ...
    "DATA_CHORE_PER_ASSIGNEE_DUE_DATES",
    "DATA_CHORE_RECURRING_FREQUENCY",
    "DATA_CHORE_ROTATION_CURRENT_ASSIGNEE_ID",
    "DATA_CHORE_ROTATION_CYCLE_OVERRIDE",
    "DATA_CHORE_STATE",
    "DATA_ASSIGNEES",
    # Constants - Assignee chore data keys
    "DATA_ASSIGNEE_BADGE_PROGRESS",
    "DATA_ASSIGNEE_CHORE_DATA",
    "DATA_ASSIGNEE_CHORE_DATA_APPROVAL_PERIOD_START",
    ...
    "DATA_ASSIGNEE_NAME",
    "DATA_ASSIGNEE_POINTS",
    # Constants - Approver shadow assignee support
